...
const styles = StyleSheet.create({
  ...
  backText: { color: '#e7e5e4', fontSize: 18 },
  ...
  field: {
    backgroundColor: '#1f2020', borderRadius: 12, padding: 16,
  ...
  input: {
    backgroundColor: '#1f2020', borderRadius: 12, padding: 14,
    color: '#e7e5e4', fontSize: 15,
    borderWidth: 1, borderColor: '#484848',
  },
  ...
  modalSheet: { backgroundColor: '#191a1a', borderTopLeftRadius: 24, borderTopRightRadius: 24, padding: 20 },
  ...
  bankRow: {
    ...
    paddingVertical: 14, borderBottomWidth: 1, borderBottomColor: '#252626',
  },
